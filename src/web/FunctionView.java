...
public class FunctionView {
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				...
				System.out.format("%-15s %-20s %-1s%n", "Attribute Name", "Attribute Ref", "Attribute Function");
				System.out.format("%-15s %-20s %-1s%n",  "--------------", "--------------------", "-------------");
	...
	static void printTreeAtt(JSONObject lInput) {
		...
		String lAttFunction = (String) (lJSONAttNode.containsKey("Function") ? lJSONAttNode.get("Function") : "No Function");
		System.out.format("%-15s %-20s %-1s %n", lAttName, lAttRef, lAttFunction);
